...
import com.example.mymessenger.messages.LatestMessagesActivity
...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        selectphote_button_register.setOnClickListener {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 0 && resultCode == Activity.RESULT_OK && data != null){
            ...
            selectphote_button_register.alpha = 0f

//            val bitmapDrawable = BitmapDrawable(bitmap)
//            selectphote_button_register.setBackgroundDrawable(bitmapDrawable)
        }
    }
    ...
    private fun saveUserToFirebaseDatabase(profileImageUrl: String){
        ...
        ref.setValue(user)
            .addOnSuccessListener {
                Log.d("RegisterActivity", "Finally we saves the user to Firebase Database")
